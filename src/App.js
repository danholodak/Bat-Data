...
function App() {
  ...
  return (
    <div className="App">
      ...
      {tab==="bvtw"&&<BatsVTreeWidths setChartTitle={setChartTitle} chartTitle={chartTitle}></BatsVTreeWidths>}
      {tab==="bvts"&&<BatsVTreeSpecies setChartTitle={setChartTitle} chartTitle={chartTitle}></BatsVTreeSpecies>}
      </main>
